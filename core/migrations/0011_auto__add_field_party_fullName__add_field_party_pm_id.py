...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Party.fullName'
        db.add_column('core_party', 'fullName', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)

        # Adding field 'Party.pm_id'
        db.add_column('core_party', 'pm_id', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('core_party', 'pm_id')
