...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_program', 'section', self.gf('django.db.models.fields.related.OneToOneField')(related_name='program_root', unique=True, null=True, to=orm['core.Section']), keep_default=False)
