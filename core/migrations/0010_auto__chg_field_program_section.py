...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Program.section'
        raise RuntimeError("Cannot reverse this migration. 'Program.section' and its values cannot be restored.")
